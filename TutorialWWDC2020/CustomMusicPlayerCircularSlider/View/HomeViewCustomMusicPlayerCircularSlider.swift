//
//  HomeViewCustomMusicPlayerCircularSlider.swift
//  TutorialWWDC2020
//
...
struct HomeViewCustomMusicPlayerCircularSlider: View {
    @StateObject var homeData = HomeViewModelCircularSlider()
            ...
            VStack{
                ...
                HStack(spacing: 55){
                    ...
                    Button {
                        ...
                        Image(systemName: homeData.isPlaing ? "pause.fill" : "play.fill")
                            .font(.title)
