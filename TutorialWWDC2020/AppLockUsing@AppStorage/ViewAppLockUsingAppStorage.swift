//
//  ViewAppLockUsingAppStorage.swift
//  TutorialWWDC2020
//
//  Created by Michele Manniello on 13/10/21.
//

import SwiftUI

struct ViewAppLockUsingAppStorage: View {
...
struct ViewAppLockUsingAppStorage_Previews: PreviewProvider {
    static var previews: some View {
        ViewAppLockUsingAppStorage()
    }
}
