//
//  ViewCustomShapesAnimation.swift
//  TutorialWWDC2020
//
//  Created by Michele Manniello on 09/12/21.
//

import SwiftUI

struct ViewCustomShapesAnimation: View {
    var body: some View {
        RatingViewCustomShapesAnimation()
    }
}

struct ViewCustomShapesAnimation_Previews: PreviewProvider {
    static var previews: some View {
        ViewCustomShapesAnimation()
    }
}

struct RatingViewCustomShapesAnimation: View {
...
//            Eyes..
            ...
            HStack(spacing: 25){
                ...
                ForEach(1...2,id:\.self){_ in
                    ZStack {
                        ...
                        EyesViewCustomShapesAnimation()
                            .stroke(Color.black,lineWidth: 3)
                            .frame(width: 100)
                        
                        EyesViewCustomShapesAnimation(value: value)
                            .stroke(Color.black,lineWidth: 3)
                            .frame(width: 100)
    ...
    //                    Eye Dot...
            ...
            SmileViewCustomShapesAnimation(value: value)
                .stroke(Color.black,lineWidth: 3)
                .frame(height: 100)
                .padding(.top,40)
...
struct SmileViewCustomShapesAnimation: Shape{
...
// Eye Shape...
struct EyesViewCustomShapesAnimation: Shape{
